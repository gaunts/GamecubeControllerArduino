// This code belongs to Froq : https://docs.google.com/document/d/1KZrORDtJBuovVAHRZjteRitBKkwibZOc7VW0PdGedEk/mobilebasic
...
void loop()
{
    ...
    Gamecube_Data_t r1 = GamecubeController1.getReport();
